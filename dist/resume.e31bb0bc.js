...
},{"./..\\img\\1.jpg":[["1.dc197a9a.jpg","img/1.jpg"],"img/1.jpg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/main.js":[function(require,module,exports) {
setTimeout(function () {
...
for (var i = 0; i < liTags.length; i++) {
  liTags[i].onmouseenter = function (x) {
    x.currentTarget.classList.add('active'); //    let li= x.currentTarget
...
!function () {
  var model = {
    // 获取数据
    init: function init() {
      var APP_ID = 'Ci8xQ65QHLrzyk19P6sApdJG-gzGzoHsz';
      var APP_KEY = '7K4sOAFo8rLl5vqbyYvSIhCp';
      AV.init({
        appId: APP_ID,
        appKey: APP_KEY
      });
...
},{"./css/style.css":"css/style.css","./js/main.js":"js/main.js","./js/message.js":"js/message.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3201" + '/');
